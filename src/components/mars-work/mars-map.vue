...
const initMars3d = (option: any) => {
  ...
  map.addLayer(graphicLayer)
   // // 创建圆形电子围栏
  const fence = new mars3d.graphic.CircleEntity({
    position: new mars3d.LngLatPoint(116.1, 31.0, 1000), // 中心点的经纬度坐标
    style: {
      text:'hhhhhhhhhh',
      radius: 1000, // 半径（单位：米）
      color: "#ddd", // 填充颜色
      opacity: 0.5,
      outline: true, // 是否显示边框
      outlineColor: "#ccc", // 边框颜色
    },
  });
  graphicLayer.addGraphic(fence)
